...
const CONFIG = {
  ...
  greeting: {
    title: "인사말",
    content: "함께하는 오늘이 쌓여 평생이 되기를 바라며\n\n매일이 행복이 되고,\n서로에게 힘이 되어 준 마음을 간직한 채\n이제 같은 내일을 걸어가려 합니다.\n\n오늘의 저희가 있기까지는\n늘 곁에서 아껴 주시고 응원해 주신\n모든 분들이 계셨기에 가능했습니다.\n소중한 날 함께하시어 축복해 주시면 감사하겠습니다."
  },
  ...
  accounts: {
    groom: [
      { role: "신랑", name: "양영훈", bank: "하나은행", number: "306-910339-12507" },
      { role: "아버지", name: "양철호", bank: "농협은행", number: "923-01-315160" },
      { role: "어머니", name: "김규연", bank: "부산은행", number: "267-12-013201-5" }
    ],
    bride: [
